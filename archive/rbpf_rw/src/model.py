...
from archive.rbpf_rw.src.bivariate_poisson import loglik
from archive.rbpf_rw.src.data import get_results, FootballResults
from archive.rbpf_rw.src.helpers import default_init_params
from archive.rbpf_rw.src.utils import RBPFState, RBPFFootballResults, EMParams
...
def main():
    from archive.rbpf_rw.src.data import WORLDCUP_2026_TEAMS, ACTIVE_TEAMS
    ...
    import os
    import numpy as np
    from archive.rbpf_rw.src.graphic import plot_all
