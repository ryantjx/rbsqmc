...
def train(config: dict, repo_root: Path) -> None:
    ...
    from archive.rbpf.src.utils.helpers import default_init_params, save_params
    from archive.rbpf.src.model.model import run_filter
    from archive.rbpf.src.model.smoothing_bfgs import run_EM
    from archive.rbpf.src.model.smoothing import E_step
...
def main(argv=None) -> int:
    ...
    # Call main() from smoothing_bfgs.py which reads config from RBSQMC_CONFIG env var.
