...
from archive.rbpf.src.utils.helpers import load_params
from archive.rbpf.src.data.bivariate_poisson import loglik_grid
from archive.rbpf.src.utils.type import EMParams, FootballResults
...
def _build_timeline(
    ...
    """
    import pandas as pd
    from archive.rbpf.src.data.data import generate_results_jax
...
def main(argv=None) -> int:
    ...
    from archive.rbpf.src.utils.helpers import resolve_teams
