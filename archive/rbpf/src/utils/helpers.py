...
from archive.rbpf.src.utils.type import EMParams, FootballResults, RBPFFootballResults, Matches, RawEMParams
...
from archive.rbpf.src.utils.graphic import plot_log_marginal_likelihood_curve
...
def resolve_teams(cfg: dict) -> set[str] | None:
    ...
    """
    from archive.rbpf.src.data.data import TEAMS_SMALL, WORLDCUP_2026_TEAMS, ACTIVE_TEAMS
