...
from archive.rbpf_2.model import (
...
# model_trained_v2.py can import this module on CPU-only machines.
...
def main():
    # Set GPU platform only when running smoothing_v2.py directly
    ...
    final_params, log_marginal_history = run_em(
        results, init_params, NUM_TEAMS, n_epochs=20, output_dir="./outputs_gpu_v2",
    )
