...
from archive.rbpf_ou.src.bivariate_poisson import loglik
from archive.rbpf_ou.src.data import get_results, FootballResults
from archive.rbpf_ou.src.helpers import default_init_params, kron_sample_psd
from archive.rbpf_ou.src.utils import RBPFState, RBPFFootballResults, EMParams
...
def main():
    from rbpf_ou.src.data import WORLDCUP_2026_TEAMS, ACTIVE_TEAMS
    ...
    import os
    import numpy as np
    from rbpf_ou.src.graphic import plot_all
