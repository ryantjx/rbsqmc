"""Predict 2026 FIFA World Cup group-stage matches from trained GD parameters.
...
Defaults:
    ...
    --output-dir   rbpf_rw_v2/outputs/predictions
"""
...
from archive.rbpf_rw_v2.src.bivariate_poisson import loglik_grid
...
# count as the GD run (otherwise the predictions are generated on a different
...
def main():
    ...
    parser.add_argument(
        "--output-dir",
        type=str,
        default="rbpf_rw_v2/outputs/predictions",
