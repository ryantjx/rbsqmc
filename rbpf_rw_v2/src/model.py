...
from rbpf_rw_v2.src.bivariate_poisson import loglik
from rbpf_rw_v2.src.data import get_results, FootballResults
from rbpf_rw_v2.src.helpers import default_init_params, kron_sample_psd
from rbpf_rw_v2.src.utils import RBPFState, RBPFFootballResults, EMParams
...
def main():
    from rbpf_rw_v2.src.data import WORLDCUP_2026_TEAMS, ACTIVE_TEAMS
    ...
    import numpy as np
    from rbpf_rw_v2.src.graphic import plot_all
