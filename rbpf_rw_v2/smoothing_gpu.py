...
def run_gd(n_particles: int, start_date: str):
    ...
    from rbpf_rw_v2.src.data import get_results, ACTIVE_TEAMS, WORLDCUP_2026_TEAMS
    from rbpf_rw_v2.src.helpers import default_init_params, params_to_dict
    from rbpf_rw_v2.src.train import MAX_GOALS, run_gd as run_gd_trainer
    ...
    try:
        from rbpf_rw_v2.src.graphic import plot_em_convergence
        plot_em_convergence(
