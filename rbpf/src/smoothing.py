...
def smoother_rts(
    ...
    instead of using a single (noisy, biased) one. With ``n_trajectories=1``
    this reduces to a 1-sample estimate.
    """
...
def loss_fn(
    ...
    M smoothed trajectories from the E-step. With M=1 this reduces to a
    1-sample estimate.
    """
    per_traj = jax.vmap(
