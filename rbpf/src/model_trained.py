import jax
import os
from rbpf.src.helpers import default_init_params, load_params, generate_rbpf_trajectory
from rbpf.src.model import compute_gamma_trajectory, run_filter
...
def main():
    ...
    if not os.path.exists(params_path):
        ...
        print("Run `uv run -m rbpf.src.smoothing` first to generate it.")
        return
