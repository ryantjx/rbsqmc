...
``rbpf_ou_v2/src/graphic.py``.

Usage:
    python model_trained.py [--params-path PATH] [--output-dir DIR]

Defaults:
    --params-path  rbpf_ou_v2/outputs_gpu/gd_params_final.json
    --output-dir   rbpf_ou_v2/outputs/smoothed
"""
...
from rbpf_ou_v2.src.data import get_results, WORLDCUP_2026_TEAMS, ACTIVE_TEAMS
from rbpf_ou_v2.src.helpers import load_params, generate_augmented_data
from rbpf_ou_v2.src.model import run_filter, compute_gamma_trajectory
from rbpf_ou_v2.src.graphic import (
    plot_top_strengths,
...
def main():
    ...
    parser.add_argument(
        "--params-path",
        type=str,
        default="rbpf_ou_v2/outputs_gpu/gd_params_final.json",
        help="Path to trained EMParams JSON.",
    )
    parser.add_argument(
        "--output-dir",
        type=str,
        default="rbpf_ou_v2/outputs/smoothed",
