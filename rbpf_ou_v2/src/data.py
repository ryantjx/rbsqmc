...
import jax
from rbpf_ou_v2.src.utils import FootballResults
from rbpf_ou_v2.src.helpers import to_jax_data

RAW_URL = "https://raw.githubusercontent.com/martj42/international_results/master/results.csv"
_DATA_DIR = os.path.join(os.path.dirname(__file__), "..", "data")  # rbpf_ou_v2/data/
