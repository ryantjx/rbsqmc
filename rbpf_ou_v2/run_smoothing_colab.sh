...
# Run rbpf_ou_v2/smoothing_gpu.py on a Colab GPU.
#
# Reuses the direct-gradient-descent machinery from rbpf_ou_v2/src/train.py
# (parameter set: estimates gamma_0, B, alpha, beta, kappa; mean_0 fixed) but
...
# config output_dir is repo-root-relative (e.g. "rbpf_ou_v2/outputs_gpu").
...
SESSION="${SESSION:-rbsqmc-test-gpu-v2}"
...
echo "============================================================"
echo "  COLAB SMOOTHING GPU — DIRECT-GD MODEL TEST RUN"
echo "  Reuses rbpf_ou_v2/src/train.py direct GD (-log Z)."
