"""Standalone Direct JAX RBPF v3 training and evaluation runner."""
...
BACKEND = "noncuthbert"
DEFAULT_OUTPUT = "rbpf_v3/outputs/smoothing_noncuthbert"


def parser() -> argparse.ArgumentParser:
    command = argparse.ArgumentParser(description="Run the direct JAX RBPF v3 smoother")
